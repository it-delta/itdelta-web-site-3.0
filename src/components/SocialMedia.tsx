...
function LinkedinIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
    return (
        <svg fill="#000000" height="24px" width="24px" version="1.1" id="Layer_1" viewBox="-143 145 512 512" xmlSpace="preserve">
...
export const socialMediaProfiles = [
  { title: 'Facebook', href: 'https://www.facebook.com/itdelta.agency', icon: FacebookIcon },
  { title: 'Linkedin', href: 'https://www.linkedin.com/company/it-delta', icon: LinkedinIcon },
  { title: 'GitHub', href: 'https://github.com/orgs/itdelta-agency/', icon: GitHubIcon },
